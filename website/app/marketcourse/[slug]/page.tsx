...
export async function generateMetadata({
  ...
  if (!lesson) return {};
  return pageMetadata({
    title: `${lesson.title} — The Free Market & Competitive Intelligence Course`,
...
const analogyIcons = [compassIcon, chartIcon, bellIcon];
    ...
    <main className="flex-1 px-6 pb-24 pt-40">
      <div className="mx-auto max-w-2xl">
        <div className="flex items-center justify-between">
          <Link href="/resources/market-intelligence" className="text-sm text-foreground/60 hover:text-foreground">
            ← Back to course info
          </Link>
        ...
        {previous && (
          <div className="mt-4 text-center">
            <Link
              href={`/marketcourse/${previous.slug}`}
