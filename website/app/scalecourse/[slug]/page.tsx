...
export async function generateMetadata({
  ...
  if (!lesson) return {};
  return pageMetadata({
    title: `${lesson.title} — The Free Scale Course`,
...
const blueprintIcon = (
  <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <path d="M8 4v16M4 12h16" strokeLinecap="round" />
  </svg>
);
const branchesIcon = (
  <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const shieldIcon = (
  <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M12 3.5 5 6v6c0 4.5 3 7.5 7 8.5 4-1 7-4 7-8.5V6l-7-2.5Z" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const analogyIcons = [blueprintIcon, branchesIcon, shieldIcon];
    ...
    <main className="flex-1 px-6 pb-24 pt-40">
      <div className="mx-auto max-w-2xl">
        <div className="flex items-center justify-between">
          <Link href="/resources/scale" className="text-sm text-foreground/60 hover:text-foreground">
            ← Back to course info
          </Link>
        ...
        {previous && (
          <div className="mt-4 text-center">
            <Link
              href={`/scalecourse/${previous.slug}`}
